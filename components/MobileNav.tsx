...
import { List, Calendar, Repeat, Tv, Lightbulb, Wallet } from 'lucide-react';
import { cn } from '@/lib/utils';

export default function MobileNav({ activeTab }: { activeTab: string }) {
    const navItems = [
        { id: 'tasks', label: 'Tasks', icon: List, type: 'searchParams' },
        { id: 'dailies', label: 'Journal', icon: Calendar, type: 'searchParams' },
        { id: 'routines', label: 'Routines', icon: Repeat, type: 'searchParams' },
