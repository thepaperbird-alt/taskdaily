    ...
    <div className="h-full flex flex-col p-4 md:p-6 overflow-hidden">
        ...
        <div className="flex items-center justify-between mb-4 md:mb-6 shrink-0">
            ...
            <div className="hidden md:flex gap-2">
                 ...
                 <button onClick={() => handleTypeChange('gadget')} className={cn("px-3 py-1.5 text-xs font-semibold rounded-md transition-colors flex items-center gap-1 border", typeFilter === 'gadget' ? "bg-black dark:bg-white text-white dark:text-black border-transparent" : "bg-white dark:bg-neutral-900 text-neutral-600 dark:text-neutral-300 border-neutral-200 dark:border-neutral-800 hover:bg-neutral-50 dark:hover:bg-neutral-800")}><ShoppingBag size={14}/> Shopping</button>
